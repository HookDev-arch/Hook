...
printf "\n\n\033[1;35mHook is being installed... ✨\033[0m"
...
eval "cd && git clone https://github.com/HookDev-arch/Hook && cd Hook"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && . <(wget -qO- https://github.com/HookDev-arch/Hook/raw/master/banner.sh) && cd ~/Hook && python3 -m hook' > ~/.bash_profile"
...
printf "\033[1;32mHook is starting...\033[0m\n"
