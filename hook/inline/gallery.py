    ...
    async def gallery(
        ...
        *,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, Hook will try to determine the filetype of these images
        :param manual_security: By default, Hook will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Hook will try to inherit inline buttons security from the caller (command)
