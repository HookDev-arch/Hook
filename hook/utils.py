...
async def answer(
    ...
    **kwargs,
    ...
    :param message: Message to answer to. Can be a tl message or hook inline object
...
async def asset_channel(
    ...
    *,
    ...
    if _folder:
        ...
        try:
            folder = next(folder for folder in folders if folder.title == "hook")
        except Exception:
            folder = None
...
def get_commit_url() -> str:
    """
    Get current Hook git commit url
...
def get_git_info() -> typing.Tuple[str, str]:
    ...
    return (
        hash_,
        f"https://github.com/HookDev-arch/Hikko/commit/{hash_}" if hash_ else "",
    )
